...
(ns ^{:doc "A clojure reader in clojure"
      :author "Bronsa"}
  cloned.clojure.tools.reader
  (:refer-clojure :exclude [read read-line read-string char
                            default-data-readers *default-data-reader-fn*
                            *read-eval* *data-readers* *suppress-read*])
  (:use cloned.clojure.tools.reader.reader-types
        [cloned.clojure.tools.reader.impl utils commons])
  (:require [cloned.clojure.tools.reader.default-data-readers :as data-readers])
  (:import (clojure.lang PersistentHashSet IMeta
                         RT Symbol Reflector Var IObj
                         PersistentVector IRecord Namespace IExceptionInfo)
