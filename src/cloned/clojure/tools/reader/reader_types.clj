...
(ns ^{:doc "Protocols and default Reader types implementation"
      :author "Bronsa"}
  cloned.clojure.tools.reader.reader-types
  (:refer-clojure :exclude [char read-line])
  (:use cloned.clojure.tools.reader.impl.utils)
...
(defn indexing-reader?
  ...
  [rdr]
  (or (instance? cloned.clojure.tools.reader.reader_types.IndexingReader rdr)
      (instance? LineNumberingPushbackReader rdr)
      (and (not (instance? cloned.clojure.tools.reader.reader_types.PushbackReader rdr))
           (not (instance? cloned.clojure.tools.reader.reader_types.StringReader rdr))
           (not (instance? cloned.clojure.tools.reader.reader_types.InputStreamReader rdr))
