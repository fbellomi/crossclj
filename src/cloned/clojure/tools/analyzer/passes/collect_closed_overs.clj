...
(ns cloned.clojure.tools.analyzer.passes.collect-closed-overs
  (:require [cloned.clojure.tools.analyzer.ast :refer [update-children]]
            [cloned.clojure.tools.analyzer.env :as env]
            [cloned.clojure.tools.analyzer.passes.cleanup :refer [cleanup]]
            [cloned.clojure.tools.analyzer.passes.uniquify :refer [uniquify-locals]]))
