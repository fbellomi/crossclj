...
(ns cloned.clojure.tools.analyzer.passes.js.validate
  (:require [cloned.clojure.tools.analyzer.ast :refer [prewalk]]
            [cloned.clojure.tools.analyzer.passes.cleanup :refer [cleanup]]
            [cloned.clojure.tools.analyzer.passes.js.infer-tag :refer [infer-tag]]
            [cloned.clojure.tools.analyzer.utils :refer [source-info resolve-sym resolve-ns]]))
