...
(ns cloned.clojure.tools.analyzer.jvm
  ...
  (:require [cloned.clojure.tools.analyzer
            ...
            [cloned.clojure.tools.analyzer.jvm.utils :refer :all :as u :exclude [box specials]]
...
(defn ^:dynamic run-passes
  "Function that will be invoked on the AST tree immediately after it has been constructed,
   ...
   Use #'cloned.clojure.tools.analyzer.passes/schedule to get a function from a set of passes that
